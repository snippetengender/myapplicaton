...
export default function ImageEditor({ onSave, onClose, isOpen }) {
    ...
    const applyCrop = () => {
        ...
        croppedImg.src = tempCanvas.toDataURL('image/jpeg', 0.9);
    };
                ...
                <>
                    ...
                    <div className="flex items-center justify-between p-4">
                        ...
                        <button
                            ...
                            className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${history.length === 0
                    ...
                    <div className="p-6 pb-8">
                            ...
                            <div className="flex items-center justify-center gap-4 mb-6">
                                {pencilSizes.map(size => (
                                    <button
                                        ...
                                        className={`rounded-full flex items-center justify-center transition-all ${pencilSize === size.width ? 'bg-pink-500' : 'bg-white'
                                            }`}
                                        style={{
                        ...
                        <div className="flex items-center justify-center gap-6">
                            ...
                            >
                                <div
                                    className={`w-14 h-14 rounded-full flex items-center justify-center transition-all ${tool === 'crop'
                            ...
                            >
                                <div
                                    className={`w-14 h-14 rounded-full flex items-center justify-center transition-all ${tool === 'draw'
                                            ? 'bg-pink-500 text-white shadow-lg'
                                            : 'bg-white text-gray-800 shadow-md'
                                        }`}
                                >
