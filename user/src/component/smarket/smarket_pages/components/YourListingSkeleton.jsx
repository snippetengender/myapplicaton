    ...
    return (
        <div className="bg-black border border-gray-800 rounded-2xl p-4 w-full animate-pulse">
            <div className="flex gap-4">
                ...
                <div className="w-32 h-32 flex-shrink-0 bg-gray-800 rounded-2xl"></div>
                ...
                <div className="flex flex-col flex-1 min-w-0 h-32">
                    ...
                    {/* Price */}
                    <div className="h-5 w-16 bg-gray-800 rounded mb-1"></div>
                    {/* Date */}
                    ...
                    <div className="w-full mt-auto h-8 bg-gray-800 rounded-lg"></div>
                </div>
            </div>
        </div>
    );
