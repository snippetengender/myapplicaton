...
// import { ArrowLeft, X, Search, Plus, Trash2 } from "lucide-react";
...
//   { id: 2, name: "React Devs", topic: "Tech" },
//   { id: 3, name: "Gamers", topic: "Gaming" },
...
//             tristique risus eu vitae felis.
//           </p>
...
//             </div>
//           ) : (
//             <div className="bg-[#2e2e2e] text-white px-4 py-3 rounded-xl mb-4 flex items-center justify-between">
...
//                 <div
//                   key={i}
//                   className="flex items-center justify-between border border-zinc-700 rounded-lg px-3 py-2"
//                 >
...
//                   className="flex-1 bg-transparent border border-zinc-700 rounded-lg px-3 py-2 text-sm outline-none"
//                 />
//                 <button
//                   onClick={addPollOption}
//                   className="px-3 py-2 bg-white text-black text-sm rounded-lg"
//                 >
//                   <Plus size={16} />
//                 </button>
//               </div>
...
//                 Note: You will get more character count when you select a
//                 network
//               </p>
//             </>
//           ) : (
...
//           Know Lorem ipsum dolor sit amet consectetur. Pulvinar risus donec
//           aenean tristique.
//         </p>
//       </div>
//     </>
...
export default function MobilePostPage() {
  ...
  const [selectedNetwork, setSelectedNetwork] = useState(
    JSON.parse(localStorage.getItem("selectedNetwork")) || null
  );
  ...
  const canPost =
    selectedTag &&
    selectedNetwork &&
    (selectedTag === "polls" ? false : title.trim().length > 0);
