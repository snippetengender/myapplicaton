...
export default function UserInfoPage() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      alert(error || "Failed to update profile details");
    } finally {
  ...
  return (
    <div className="min-h-screen bg-black text-brand-off-white px-4 py-6 flex flex-col justify-between">
      <div>
        ...
        <p className="text-sm mb-4">{isEditMode ? "update your details" : "we need your"}</p>
      ...
      <div className="flex justify-end mt-10 mb-4">
        <button
          ...
          className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors duration-200 ${!isFormValid || isSubmitting
